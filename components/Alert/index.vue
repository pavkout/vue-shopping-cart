<template>
  <TransitionRoot as="template" :show="open">
    <Dialog as="div" class="relative z-10" @close="onReject">
      <TransitionChild
        as="template"
      ...
      <div class="fixed z-10 inset-0 overflow-y-auto">
        ...
        >
          ...
          >
            <div
              class="flex flex-col max-w-md gap-2 p-6 rounded-md shadow-md bg-white text-gray-900 dark:bg-gray-900 dark:text-gray-100"
            >
              <h2
              ...
              >
                <svg
                  ...
                  viewBox="0 0 512 512"
                  class="w-6 h-6 fill-current shrink-0 text-purple-400"
                >
                  <path
